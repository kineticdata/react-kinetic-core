...
describe('translations api', () => {
  ...
  describe('updateContext', () => {
    ...
    test('success update', async () => {
      ...
      const result = await updateContext({ contextName: 'custom.test', context: { name: 'custom.other' }});
      expect(axios.put.mock.calls).toEqual([
        [
    ...
    test('forbidden', async () => {
      ...
      const result = await updateContext({ contextName: 'custom.test', context: {}});
      expect(axios.put.mock.calls).toEqual([
        [
          'space/app/api/v1/translations/contexts/custom.test',
          {},
  ...
  describe('updateContextKey', () => {
    ...
    test('success update', async () => {
      ...
      const result = await updateContextKey(
        { contextName: 'custom.test', keyHash: 'asdf', key: { name: 'newKey' } }
      );
      expect(axios.put.mock.calls).toEqual([
        [
  ...
  describe('fetchTranslations', () => {
    ...
    test('success fetch cached', async () => {
      ...
      const result = await fetchTranslations(
        { cache: true, contextName: 'custom.test', localeCode: 'en' }
      );
      expect(axios.get.mock.calls).toEqual([
        [
          'space/app/api/v1/translations/entries',
          { params: { cache: true, context: 'custom.test', locale: 'en' }, headers: {} },
        ],
      ]);
      expect(result).toEqual({
        entries: [{}, {}],
    ...
    test('success fetch by context and locale', async () => {
      ...
      const result = await fetchTranslations({ contextName: 'custom.test', localeCode: 'en' });
      expect(axios.get.mock.calls).toEqual([
        [
          'space/app/api/v1/translations/entries',
    ...
    test('success fetch by context and keyHash', async () => {
      ...
      const result = await fetchTranslations({ contextName: 'custom.test', keyHash: 'asdf' });
      expect(axios.get.mock.calls).toEqual([
        [
          'space/app/api/v1/translations/entries',
  ...
  describe('upsertTranslations', () => {
    ...
    test('success upsert single', async () => {
      ...
      const result = await upsertTranslations({ translation: { value: 'test' } });
      expect(axios.post.mock.calls).toEqual([
        [
          'space/app/api/v1/translations/entries',
          { value: 'test' },
    ...
    test('success upsert list', async () => {
      ...
      const result = await upsertTranslations({ translations: [{ value: 'test' }]});
      expect(axios.post.mock.calls).toEqual([
        [
          'space/app/api/v1/translations/entries',
          [{ value: 'test' }],
    ...
    test('success import', async () => {
      ...
      const result = await upsertTranslations({ import: 'csv', file: testFile });
      expect(axios.post.mock.calls).toEqual([
        [
          'space/app/api/v1/translations/entries',
          testFormData,
          { params: { import: 'csv' }, headers: { 'Content-Type': 'multipart/form-data' } },
        ],
      ]);
      expect(result).toEqual({
        message: "success",
  ...
  describe('deleteTranslations', () => {
    ...
    test('success delete specific', async () => {
      ...
      const result = await deleteTranslations(
        { contextName: 'custom.test', localeCode: 'en', keyHash: 'asdf' }
      );
      expect(axios.delete.mock.calls).toEqual([
        [
          'space/app/api/v1/translations/entries',
          { params: { context: 'custom.test', locale: 'en', keyHash: 'asdf' }, headers: {} },
        ],
      ]);
      expect(result).toEqual({
        message: 'success',
