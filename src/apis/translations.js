...
export const fetchAvailableLocales = (options = {}) => {
  const paramModifier = params => options.localeCode ? ({
    ...params,
...
export const fetchStagedTranslations = (options = {}) => {
  const paramModifier = params => options.contextName ? ({
    ...params,
...
export const disableLocale = (options = {}) => {
  ...
  return axios
    .delete(
      `${ENDPOINT_PREFIX}/settings/locales/${options.localeCode}`,
      {
        params: paramBuilder(options),
        headers: headerBuilder(options),
      }
...
export const updateContextKey = (options = {}) => {
  ...
  return axios
    .put(
      `${ENDPOINT_PREFIX}/contexts/${options.contextName}/keys/${options.keyHash}`,
      options.key,
      {
        params: paramBuilder(options),
        headers: headerBuilder(options),
...
export const upsertTranslations = (options = {}) => {
  ...
  const paramModifier = params => options.import
    ? { ...params, import: options.import }
    : params;
  const headerModifier = headers => options.import
